  ...
  },
  {
    ...
    options: [
      ...
      { text: "American shad" },
      {
        text: "Fish",
        note:
          "Too vague for a page whose entire subject is this particular species — the reader deserves at least its name.",
      },
      {
        text: DECORATIVE,
        note:
          "This illustration is the subject of the page, not ornament — marking it decorative would hide real content from screen-reader users.",
      },
    ],
    correctIndex: 1,
    explanation:
      "This illustration is the page’s actual subject, so it’s meaningful content and needs alt text. But keep it concise: “American shad” identifies it, and the detailed anatomy belongs in the body text, not the alt. Don’t pad it into a paragraph, and don’t drop it to a vague “Fish.”",
  },
  {
    ...
    options: [
      ...
      },
      {
        text: "Photo",
        note:
          "This adds nothing — the screen reader has already announced that it’s an image.",
      },
    ],
    correctIndex: 1,
    explanation:
